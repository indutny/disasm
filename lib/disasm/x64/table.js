...
function prefixExt(table, op, map) {
  ...
  table[op] = function prefixSelect(prefix) {
    var res;
...
// 0x60
prefixExt(two, 0x6e, {
  none: { type: 'movd', operands: [ 'Pd', 'Ey' ] },
  'op-override': { type: 'vmovd', operands: [ 'Vy', 'Ey' ] }
});
prefixExt(two, 0x6f, {
...
prefixExt(two, 0x7e, {
  none: { type: 'movd', operands: [ 'Ey', 'Pd' ] },
  'op-override': { type: 'vmovd', operands: [ 'Ey', 'Vy' ] },
...
spanOperand(two, 0xbe, 'movsx', [
  [ 'Gv', 'Eb' ], [ 'Gv', 'Ew' ]
]);

// 0xc0
spanOperand(two, 0xc0, 'xadd', [
  [ 'Eb', 'Gb' ], [ 'Ev', 'Gv' ]
]);
